...
class Rules extends Component {
  constructor(props) {
    ...
    this.state = {};
    this.rules = [
      "1. There are 31 questions in total with many possible paths to reach from the start to the end.Some paths longer than others.",
      ...
      "5. Answering a question gives you 1 point and answering all the questions in a path gives you a bonus 9 points.Answering all the questions in the maze gives you bonus 5 points.",
